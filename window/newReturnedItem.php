...
<div id="windowRn" class="windowDialog">
  <div class="windowContent">
    <div class="windowHead"><span class="windowClose close_windowRn">&times;</span>New Item</div>
    <div class="windowBody">
      ...
      <div class="frameItem">
        <div class="itemInputGroup">
          ...
          <button id="save_returnedItem" class="itemButton">Save <span class="glyphicon glyphicon-save"></span></button>
        </div>
      </div>
    </div>
  </div>
