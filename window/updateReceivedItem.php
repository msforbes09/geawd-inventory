...
<div id="windowInvoice" class="windowDialog">
  <div class="windowContent">
    <div class="windowHead"><span class="windowClose close_windowInvoice">&times;</span>Update Item</div>
    <div class="windowBody">
      ...
      <div class="frameItem">
        <div class="itemInputGroup">
          ...
          <button id="update_receivedItem" class="itemButton">Save <span class="glyphicon glyphicon-save"></span></button>
        </div>
      </div>
    </div>
  </div>
