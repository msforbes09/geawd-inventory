...
<div id="windowRis" class="windowDialog">
  <div class="windowContent">
    <div class="windowHead"><span class="windowClose close_windowRis">&times;</span>New Item</div>
    <div class="windowBody">
      ...
      <div class="frameItem">
        <div class="itemInputGroup">
          ...
          <button id="save_releasedItem" class="itemButton">Save <span class="glyphicon glyphicon-save"></span></button>
        </div>
      </div>
    </div>
  </div>
